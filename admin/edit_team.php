...
function main()
{
	...
	<div class="portlet box green">
		...
		<div class="portlet-body form">
			<form action="update_team.php" method="post" enctype="multipart/form-data" name="frm" id="frm" class="form-horizontal form-bordered">
				<div class="form-body">
					...
					<div class="form-group">
						...
						<div class="col-md-3">
							<input name="name" type="text" class="form-control" id="name" value="<?php echo stripslashes($page->title) ?>" placeholder="Enter Page title">
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-md-3">
							<input name="position" type="text" class="form-control" id="position" value="<?php echo stripslashes($page->subtitle) ?>" placeholder="Enter Page title">
						</div>
					</div>
