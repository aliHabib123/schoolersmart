...
function main()
{
	...
	<div class="portlet box blue">
		<div class="portlet-title">
			<div class="caption">
				<i class="fa fa-globe"></i>IDEAS & RESOURCES MANAGEMENT
			</div>
			<div class="actions">
				<div class="btn-group">
					...
					<div id="sample_2_column_toggler" class="dropdown-menu hold-on-click dropdown-checkboxes pull-right">
						...
						<label><input type="checkbox" checked data-column="<?php echo "2"; ?>"><?php echo "Date"; ?></label>
						<label><input type="checkbox" checked data-column="<?php echo "3"; ?>"><?php echo "Image"; ?></label>
						<label><input type="checkbox" checked data-column="<?php echo "4"; ?>"><?php echo "Description"; ?></label>
						<label><input type="checkbox" checked data-column="<?php echo "5"; ?>"><?php echo "Active"; ?></label>
						<label><input type="checkbox" checked data-column="<?php echo "6"; ?>"><?php echo "Display Order"; ?></label>
					</div>
				</div>
				<div class="btn-group">
					<a id="sample_editable_1_new" class="btn green" href="new_resource.php">
				...
				<tbody>
					...
					?>
						<tr id="<?php echo $row->id; ?>">
							...
							<td>
								<a class="btn btn-xs yellow" href="edit_resource.php?id=<?php echo $row->id;?>">
									Edit
