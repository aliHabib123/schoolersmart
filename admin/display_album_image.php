			...
			<div class="actions">
				<div class="btn-group">
					...
					<div id="sample_2_column_toggler" class="dropdown-menu hold-on-click dropdown-checkboxes pull-right">
						...
						<label><input type="checkbox" checked data-column="<?php echo "2"; ?>"><?php echo "Caption"; ?></label>
						<label><input type="checkbox" checked data-column="<?php echo "3"; ?>"><?php echo "Parent Album"; ?></label>
					</div>
				</div>
				<div class="btn-group">
					<a id="sample_editable_1_new" class="btn green" href="new_album_image.php?id=<?php echo $_GET['id'];?>">
				...
				<tbody>
                    ...
                    for ($rc = 0; $rc < count($records); $rc++) {
						...
						<tr id="<?php echo $banner->id; ?>">
							...
							<td><?php echo $banner->albumId; ?></td>
							<td>
								<a class="btn btn-xs yellow" href="edit_album_image.php?id=<?php echo $banner->id; ?>">
									Edit
									<i class="fa fa-edit"></i>
								</a>
							</td>
							<td>
								<a class="btn btn-xs red" href="javascript:deleteAjax('album_image', '<?php echo $banner->id; ?>')">
