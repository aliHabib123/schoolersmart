...
{ ?>
	...
	<div class="portlet box green">
		<div class="portlet-title">
			<div class="caption"><i class="fa fa-reorder"></i>Create Idea & Resource</div>
		</div>
		<div class="portlet-body form">
			<form action="insert_resource.php" method="post" enctype="multipart/form-data" name="frm" id="frm" class="form-horizontal form-bordered">
				<div class="form-body">
					...
					<div class="form-group">
						...
						<div class="col-md-3">
							<input name="date" type="text" class="form-control" id="date" value="" placeholder="Enter Date">
						</div>
					</div>
					<div class="form-group">
