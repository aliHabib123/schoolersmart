...
function main()
{
	...
	<div class="portlet box blue">
		<div class="portlet-title">
			<div class="caption">
				<i class="fa fa-globe"></i>SHOPPING SLIDER MANAGEMENT
			</div>
			<div class="actions">
				<div class="btn-group">
					...
					<div id="sample_2_column_toggler" class="dropdown-menu hold-on-click dropdown-checkboxes pull-right">
						...
						<label><input type="checkbox" checked data-column="<?php echo "2"; ?>"><?php echo "Link"; ?></label>
				...
				<div class="btn-group">
					<a id="sample_editable_1_new" class="btn green" href="new_shopping_slider.php">
				...
				<tbody>
					...
					?>
						<tr id="<?php echo $row->id; ?>">
							...
							<td>
								<a class="btn btn-xs yellow" href="edit_shopping_slider.php?id=<?php echo $row->id;?>">
									Edit
