...
function main()
{
	...
	$condition .= " 1 AND album_type = 'content' order by $fieldName $orderBy ";
	...
	$records = $albumMySqlExtDAO->select($condition);
	?>
	<div class="portlet box blue">
		<div class="portlet-title">
			<div class="caption">
				<i class="fa fa-globe"></i>Album MANAGEMENT
				<!--
			...
			<div class="actions">
				...
				<div class="btn-group">
					<a id="sample_editable_1_new" class="btn green" href="new_album.php">
				...
				<tbody>
					...
					?>
						<tr id="<?php echo $banner->id; ?>">
							...
							<td>
								<a class="btn btn-xs yellow" href="edit_album.php?id=<?php echo $banner->id;?>">
									Edit
									<i class="fa fa-edit"></i>
								</a>
							</td>
							<td>
								<a class="btn btn-xs red" href="javascript:deleteAjax('album', '<?php echo $banner->id; ?>')">
									<i class="fa fa-times"></i>
									Delete
								</a>
							</td>
							<td>
								<a class="btn btn-xs green" href="display_album_image.php?id=<?php echo $banner->id;?>">
